...
import lyneraMark from './assets/lynera-mark-transparent.png';
import './styles.css';
...
export default function App(){
 ...
 return <div className="app-shell"><header className="topbar"><button className="brand" onClick={()=>setScreen('home')} aria-label="Go to Today"><img src={lyneraMark} alt=""/><strong>LYNERA</strong></button></header>
