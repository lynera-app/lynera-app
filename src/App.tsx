...
export default function App(){
 ...
 return <div className="app-shell"><header className="topbar"><button className="brand" onClick={()=>setScreen('home')}><img src="./icons/icon-64.png" alt=""/><span><strong>Lynera</strong><small>Private symptom patterns</small></span></button><span className="device-badge"><i/>On-device</span></header>
