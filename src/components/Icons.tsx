export function Icon({name,size=22}:{name:string;size?:number}){
  ...
  if(name==='chart')return <svg {...p} aria-hidden="true"><path d="M3 21h18"/><rect x="4.5" y="12" width="3" height="7" rx="1"/><rect x="10.5" y="7" width="3" height="12" rx="1"/><rect x="16.5" y="3" width="3" height="16" rx="1"/></svg>;
